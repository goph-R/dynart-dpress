 ...
 *
 * **Only what the author attached on purpose.** An image inside the body is not one of these:
 * it is a `media#<id>` reference in the markdown, and it is on the page already. Attachments
 * are the list of files hanging off the bottom of it.
 *
